...
import {DateFormats} from '../util/event-utils';
...
/**
 * Создает шаблон для секции с информацией о пункте назначения
 *
 * @param destinationInfo - Информация о пункте назначения
 * @returns {string} - HTML-строка с шаблоном
 */
